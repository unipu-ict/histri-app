...
/**
 * Created by bozidarkokot on 08/07/16.
 */
...
public  class InstitutionGrid {
    ...
    public static void setupGridLayout(GridLayout gridLayout, final Context context) {
        ...
        for(int i = 0; i < institutionModels.size(); i++){
            ...
            iconView.setImageResource(R.drawable.ic_location_city_black_24dp);
            ...
            linearLayoutContainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context,InstitutionDescription.class);
